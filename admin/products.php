                    ...
                    <div class="nav-collapse collapse">
                        ...
                        <ul class="nav">
                            <li>
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a tabindex="-1" href="user.php">Listed User</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                  ...
                  <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">List of items</div>
                            </div>
                            ...
                            <div class="navbar navbar-inner block-header">
                            	 <a href="tambah-barang.php" class="btn"><i class="icon-plus"></i> Add Product</a>
                            </div>
                        </div>
                        <!-- /block -->
                    </div>
