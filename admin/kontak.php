                    ...
                    <div class="nav-collapse collapse">
                        ...
                        <ul class="nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a tabindex="-1" href="barang.php">product</a>
                                    </li>
                                    <li>
                                        <a tabindex="-1" href="pesan.php">message</a>
                                    </li>
                                    <li>
                                        <a tabindex="-1" href="pembeli.php">buyer</a>
                                    </li>
                                    <li>
                                        <a tabindex="-1" href="about-us.php">about</a>
                                    </li>
                                    <li>
                                        <a tabindex="-1" href="kontak.php">Kontact</a>
                                    </li>
                                    <li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a tabindex="-1" href="user.php">list User</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
            ...
            <div class="row-fluid">
                <div class="span2" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        ...
                        <li>
                            <a href="barang.php"><i class="icon-chevron-right"></i> products</a>
                        </li>
                        <li>
                            <a href="pesan.php"><i class="icon-chevron-right"></i> Message</a>
                        </li>
                        <li>
		                    ...
		                    <div class="row-fluid">
		                        ...
		                        <div class="block">
		                            <div class="navbar navbar-inner block-header">
		                                <div class="muted pull-left">Manage contact page</div>
		                            </div>
                                    <h2 align="center">Set Contact Page</h2>
